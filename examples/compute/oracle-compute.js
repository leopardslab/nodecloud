...
function launchInstance() {
    const createContainerInstanceDetails = {
        ...
        containerRestartPolicy:
          containerinstances.models.ContainerInstance.ContainerRestartPolicy.OnFailure,
        freeformTags: {
...
function get(){
    ...
    compute.get(getContainerRequest).then(res=>{
...
function deleteInstance() {
    const deleteContainerInstanceRequest = {
        containerInstanceId: "ocid1.test.oc1..<unique_ID>EXAMPLE-containerInstanceId-Value",
      };
  compute
