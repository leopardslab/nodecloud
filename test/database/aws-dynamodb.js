...
describe("AWS DynamoDB", () => {
  xit("should create an item", done => {
    nock("https://dynamodb.us-west-2.amazonaws.com:443", {
  ...
  it("should update an item", done => {
    nock("https://dynamodb.us-west-2.amazonaws.com:443", {
      ...
      .post("/", {
        ...
        ExpressionAttributeValues: { ":y": { N: "2015" } },
        Key: { artist: { S: "Taylor Swift" } },
      ...
      .reply(
        200,
        { Attributes: { artist: { S: "Taylor Swift" }, Year: { N: "2015" } } },
        [
          "Server",
          "Server",
          "Date",
  ...
  it("should query a table", done => {
    nock("https://dynamodb.us-west-2.amazonaws.com:443", {
      ...
      .post("/", {
        ExpressionAttributeValues: { ":v1": { S: "Taylor Swift" } },
      ...
      .reply(
        ...
        {
          Count: 1,
          Items: [{ artist: { S: "Taylor Swift" }, Year: { N: "2015" } }],
          ScannedCount: 1
        },
        [
          "Server",
