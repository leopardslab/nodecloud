...
function transform(code, classData) {
    return __awaiter(this, void 0, void 0, function () {
        var node, importStatments, addFunctions, addIdentifiers, addComments, result_1, result_2, result_3;
                    ...
                    addIdentifiers = function (context) { return function (rootNode) {
                        ...
                        function visit(node) {
                            ...
                            if (ts.isStringLiteral(node) && node.text === "pkgName") {
                                return ts.createStringLiteral("@azure/" + classData.functions[0].pkgName);
                            }
                            if (ts.isIdentifier(node) && dummyIdentifiers.includes(node.text)) {
                                var updatedIdentifier = void 0;
                                switch (node.text) {
                                    case "ClassName":
                                        updatedIdentifier = ts.updateIdentifier(ts.createIdentifier("Azure_" + classData.serviceName));
                                        break;
                                    case "SDKClassName":
