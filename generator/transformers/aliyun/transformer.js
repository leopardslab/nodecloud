...
var extractParams = function(classData, identifierCount) {
  var parameters = classData.functions[identifierCount].params.map(function(
    param
  ) {
...
exports.transform = function(code, classData) {
    ...
    return __generator(this, function(_a) {
      switch (_a.label) {
          ...
          addComments = function(context) {
            return function(rootNode) {
              ...
              var visit = function(node) {
                ...
                if (ts.isMethodDeclaration(node)) {
                  var parameters = classData.functions[count].params.map(
                    function(param) {
                      var statment;
                      if (param.optional) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            runTransformation(toSourceFile(result_1), addIdentifiers),
          ];
        case 2:
          result_2 = _a.sent();
          return [
