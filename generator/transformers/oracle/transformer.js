                    ...
                    addIdentifiers = function (context) { return function (rootNode) {
                        ...
                        function visit(node) {
                            ...
                            if (ts.isIdentifier(node) && dummyIdentifiers.includes(node.text)) {
                                ...
                                switch (node.text) {
                                    case '_sdkFileName':
                                        updatedIdentifier = ts.updateIdentifier(ts.createIdentifier(classData.sdkName));
                                        break;
                                    case 'ClassName':
                                        updatedIdentifier = ts.updateIdentifier(ts.createIdentifier('Oracle_' + classData.serviceName));
                                        break;
                                    case '_sdkClassName':
