...
class ALI_LoadBalancer {
    ...
    */
    create(regionId, loadBalancerName, loadBalancerSpec, params = undefined) {
        return new Promise((resolve, reject) => {
            this._slb.createLoadBalancerInstance(regionId, loadBalancerName, loadBalancerSpec, params)
    ...
    */
    list(regionId, params = undefined) {
        return new Promise((resolve, reject) => {
            this._slb.describeLoadBalancers(regionId, params)
                .then(data => resolve(data))
                .catch(err => reject(err));
        });
    }
    ...
    */
    describe(regionId, loadBalancerId, params = undefined) {
        return new Promise((resolve, reject) => {
            this._slb.describeLoadBalancerAttribute(regionId, loadBalancerId, params)
                .then(data => resolve(data))
                .catch(err => reject(err));
        });
    }
    ...
    */
    delete(loadBalancerId, params = undefined) {
        return new Promise((resolve, reject) => {
            this._slb.deleteLoadBalancer(loadBalancerId, params)
                .then(data => resolve(data))
                .catch(err => reject(err));
        });
    }
