...
class Oracle_BlockStorage {
    ...
    constructor(ocisdk, params, clientConfiguration) {
        ...
        this._blockstorageClient = this._oci.BlockstorageClient(params, clientConfiguration);
    }
    /**
    ...
    delete(deleteVolumeRequest) {
        return new Promise((resolve, reject) => {
            this._blockstorageClient.deleteVolume(deleteVolumeRequest)
                .then(data => resolve(data))
                .catch(err => reject(err));
        });
    }
    ...
    get(getVolumeRequest) {
        return new Promise((resolve, reject) => {
            this._blockstorageClient.getVolume(getVolumeRequest)
                .then(data => resolve(data))
                .catch(err => reject(err));
        });
    }
    ...
    list(listVolumesRequest) {
        return new Promise((resolve, reject) => {
            this._blockstorageClient.listVolumes(listVolumesRequest)
                .then(data => resolve(data))
                .catch(err => reject(err));
        });
    }
